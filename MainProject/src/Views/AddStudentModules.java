...
/* 
 * This is literally the same thing as RegistrarModules.java but instead of remove modules,
 * there is a form to add modules for a student
 */

public class AddStudentModules extends JPanel {
	...
	public AddStudentModules(PrimaryFrame pf) {
		frame = pf;
	}
